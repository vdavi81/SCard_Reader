...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define DATA_PERM_MSEC    100
#define IN_OUT_MSEC       250
/* USER CODE END PD */
...
/* Definitions for InOut */
osThreadId_t InOutHandle;
const osThreadAttr_t InOut_attributes = {
  .name = "InOut",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for DataPerm */
osThreadId_t DataPermHandle;
const osThreadAttr_t DataPerm_attributes = {
  .name = "DataPerm",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow4,
};
/* Definitions for myQueueINs */
osMessageQueueId_t myQueueINsHandle;
const osMessageQueueAttr_t myQueueINs_attributes = {
  .name = "myQueueINs"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_InOutFunc */
/**
  * @brief  Function implementing the InOut thread.
...
/* USER CODE BEGIN Header_DataPermFunc */
/**
* @brief Function implementing the DataPerm thread.
* @param argument: Not used
* @retval None
*/
...
void DataPermFunc(void *argument)
{
  ...
  for(;;)
  {
    ...
    if(status == osOK)
    {
    	...
    	if(msg_type == 0xAA)
    	{
    		// Save value of INs in the EEPROM
    	}
    }
  }
  /* USER CODE END DataPermFunc */
}
